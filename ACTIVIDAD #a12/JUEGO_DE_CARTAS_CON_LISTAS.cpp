...
int main(){
    ...
    for (int i = 0; i < 5; i++) {
        ...
        //ver si alguien ya a ganado antes que termine el ciclo
...
void mostrarCarta(Carta unaCarta){
    ...
    switch (unaCarta.palo){
        case Corazones: cout << "corazones " << "\033[31m Roja \033[0m"; break;
        case Diamantes: cout << "diamantes " << "\033[31m Roja \033[0m"; break;
        case Treboles: cout << "treboles " << "\033[0m Negra \033[0m"; break;
        case Picas: cout << "picas " << "\033[0m Negra \033[0m"; break;
    }
    cout << endl;
}

void agregarCarta(int n, Palos p){
    Carta unaCarta;             //Corazones, Diamantes, Treboles, Picas
    unaCarta.numero = n;
    unaCarta.palo = p;
