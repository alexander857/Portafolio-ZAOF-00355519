...
void mostrarLibrosMisterios(Libro p){
    cout << "\n"; 
...
T acceder();
void mostrarLibroEspanol();
void mostrarLibroMisterio();
...
int main(){
    ...
    do{
        ...
        cout << "\t9) Acceder\t\t\t10) Mostrar libros en espanol\n";
        cout << "\t11) Mostrar libros de misterio\t12) Eliminar libros de ciencia ficcion\n";
        cout << "\t13) Salir\n";
        cout << "\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            case 10: mostrarLibroEspanol(); break;
            case 11: mostrarLibroMisterio(); break;
            case 12: eliminarCienciaFiccion(); break;
